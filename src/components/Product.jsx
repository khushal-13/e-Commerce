...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `http://e-commerce-env.eba-3fqbn8ha.eu-north-1.elasticbeanstalk.com/api/product/${id}`
        );
    ...
    const fetchImage = async () => {
      const response = await axios.get(
        `http://e-commerce-env.eba-3fqbn8ha.eu-north-1.elasticbeanstalk.com/api/product/${id}/image`,
        { responseType: "blob" }
      );
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete(`http://e-commerce-env.eba-3fqbn8ha.eu-north-1.elasticbeanstalk.com/api/product/${id}`);
      removeFromCart(id);
